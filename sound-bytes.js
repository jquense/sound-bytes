var util = require("util")
  ...
  , dataCleaner = require('./lib/metadataCleaner.js')
...
function SoundBytes(file, size, opts){
    var self = this;
    emitter.call(this)
...
util.inherits(SoundBytes, emitter);

SoundBytes.prototype.startParser = function() {
    var self   = this
    ...
    if ( !parser ) {
        ...
        err.type = "SoundBytesNotFoundError";
...
SoundBytes.prototype.mpegParsing = function(tagParser, type) {
    var self = this
    ...
    frameParser.once('data', function(frame){
        ...
        self.readInfo({ type: 'duration', value: SoundBytes.getMp3Duration(readSize + this.bytesRead, info.bitRate, self.size) }) 
...
SoundBytes.prototype.checkTagType = function(chunk) {
    var type;
...
SoundBytes.prototype.finish = function(tags) {
     this.emit('info', this.metadata)
}

SoundBytes.prototype.readInfo = function(data) {
...
SoundBytes.prototype._set = function(key, value) {
...
SoundBytes.getMp3Duration = function (byteTofirstFrame, bitRate, fileSize ) {
    return Math.floor((fileSize - byteTofirstFrame) / ( bitRate / 8)) || 0;
};

module.exports = SoundBytes;